...
export type _SyncFields<T> = {
  ...
  bankId: T extends true ? string : null; // UUID of bank record
  bankSyncId: T extends true ? string : null; // Bank identifier (ASPSP for Enable Banking, requisitionId for GoCardless)
